...
public class SpellingTest extends GUIElement {
	...
	public SpellingTest(JFrame frame, Data data, List<Word> list, boolean isReview) {
	...
	private void speakWord(final String word) {
		...
		SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
			protected Void doInBackground() throws Exception {
				...
				ProcessBuilder builder = new ProcessBuilder("/usr/bin/festival", _data.getVoiceCode(_data.getVoice()), "(SayText \"" + word + "\")");
