...
public class AddRemoveWord extends GUIElement {
	...
	protected AddRemoveWord(JFrame frame, DataStore data, JPanel previous) {
		super(frame, data);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source.equals(_selectOperation)) {
			...
			updateWords();
			System.out.println("Remove word: " + _removeInput.getSelectedItem());
			/*
			...
			System.out.println("Add word: " + _addInput.getText());
			/*
